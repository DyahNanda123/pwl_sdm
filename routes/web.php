...
Route::group(['prefix' => 'kegiatan'], function () {
    ...
    Route::get('/{id}/edit', [KegiatanController::class, 'edit']);  // menampilkan halaman form edit level
    Route::put('/{id}', [KegiatanController::class, 'update']);     // menyimpan perubahan data level
