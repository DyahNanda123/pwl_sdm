            ...
            @else
                <form method="POST" action="{{ url('/kegiatan/' . $kegiatan->kegiatan_id) }}" class="form-horizontal">
                        ...
                        <div class="col-11">
                            <select class="form-control" id="kategori_id" name="kategori_id" required>
                                ...
                                {{-- @foreach($kategori as $item)
                                    <option value="{{ $item->kategori_id }}" {{ old('kategori_id', $kegiatan->kategori_id) == $item->kategori_id ? 'selected' : '' }}>
                                        {{ $item->kategori_nama }}
                                    </option>
                                @endforeach --}}
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="date" class="form-control" id="tanggal_pelaksanaan" name="tanggal_pelaksanaan"
                                value="{{ old('tanggal_pelaksanaan', $kegiatan->tanggal_pelaksanaan) }}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <textarea class="form-control" id="detail_kegiatan" name="detail_kegiatan" rows="4" required>{{ old('detail_kegiatan', $kegiatan->detail_kegiatan) }}</textarea>
