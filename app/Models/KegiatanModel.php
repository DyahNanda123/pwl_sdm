...
{
    use HasFactory;
    protected $table = 'kegiatan'; // Mendefinisikan nama tabel yang digunakan oleh model ini
    protected $primaryKey = 'kegiatan_id'; // Mendefinisikan primary key dari tabel yang digunakan
    protected $fillable = ['kategori_id','kegiatan_kode','kegiatan_nama', 'deskripsi', 'tanggal_mulai', 'tanggal_selesai', 'status', 'jenis_kegiatan'];
